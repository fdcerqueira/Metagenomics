...
function show_help() {
    ...
    echo " -bins < to run instrain jsut with the bins from the metagenomic assembly, write -bins y >"
    echo ""
    ...
    echo " e.g. ./instrain_test.sh -n 20 -gen_dir /path/to/genomes -ani 0.98 -r_ani 0.95 -min_cov 10 -min_scaf 10 -min_gen 5 -bins y"
